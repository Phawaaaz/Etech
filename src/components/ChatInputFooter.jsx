...
export default function ChatInputFooter() {
  return (
    <footer className="w-full max-w-2xl mt-8 mb-4 relative z-10">
      <div className="relative flex items-center w-full bg-[#030303] rounded-full pl-6 shadow-2xl border border-white/5">
        <input
          type="text"
        ...
        />
        <button className="w-10 h-10 md:w-11 md:h-11 bg-white flex items-center justify-center rounded-[2.5rem] hover:bg-gray-400 transition-colors shrink-0 ml-4 cursor-pointer group">
